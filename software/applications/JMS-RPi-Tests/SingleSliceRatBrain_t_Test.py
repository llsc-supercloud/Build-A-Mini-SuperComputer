...
dataDir = "/Users/sullivan/Dropbox/UMass/JMS-RPi-Tests/"
testfile = "RPiTestData001.txt"
filename = os.path.join(dataDir, testfile)
...
np.savetxt(file_out,img_output,fmt='%.4d')
#
# Display the matrix as an image
plt.imshow(img_output, cmap='gray', interpolation='nearest')
plt.show(block=False)
# Pause the display for 3 seconds
plt.pause(3)
